var mensData = [
  {
    image_url:
      "https://th.bing.com/th/id/OIP.FuQz-Cq2_cb4tJ-NSA4odQHaEX?pid=ImgDet&rs=1",
...
let childs = document.getElementById("big").getElementsByTagName("div");
for (let i = 0; i < 36; i++) {
  let child = childs[i];
  // let img = mensData[i].image_url;
  // let nimg = document.createElement("img")

  // nimg.setAttribute("src",img)
  // console.log(nimg)
  let name = mensData[i].name;
  let price = mensData[i].price;
  let strikedoffprice = mensData[i].strikedoffprice;
  child.innerText =
    name +
    "\n" +
    "Price : " +
  ...
  child.append(cart);
  cart.addEventListener("click", () => additem(name, price));
}
